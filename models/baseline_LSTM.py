        ...
        for layer1 in layer1_choice:
            for layer2 in layer2_choice:
                for layer3 in layer3_choice:
                    ...
                    model = LSTMModel(hidden_dim = layer1, fc1_size=layer2, fc2_size=layer3)
                    model.to(device)
                    ...
                    for epoch in range(nepochs):
                        ...
                        if avg_val_auc > best_LSTM:
                            # best LSTM is based on the val AUC metric
                            best_LSTM = avg_val_auc
                            ...
                            #best_LSTM_combo = (nepochs, lr, layer1, layer2, layer3)
                            best_epochs = nepochs
                            best_lr = lr
                            best_layer1 = layer1
                            best_layer2 = layer2
...
model = LSTMModel(hidden_dim = best_layer1, fc1_size=best_layer2, fc2_size=best_layer3)
model.to(device)
