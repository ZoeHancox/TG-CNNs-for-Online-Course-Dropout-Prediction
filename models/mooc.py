...
class Dense3DConv(nn.Module):
    ...
    def forward(self, x):
        ...
        out, cell_state = self.lstm(torch.transpose(out, 1, 2)) # switching the layout to suit LSTM switching the position of the sequence_length and out_chans
